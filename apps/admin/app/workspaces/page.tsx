...
export default function AdminWorkspacesPage() {
  ...
  const loadWorkspaces = async (p: number) => {
    ...
    if (!res.ok) { setError('Failed to load workspaces'); setLoading(false); return; }
  ...
  return (
    <div className="admin-layout">
      ...
      <div className="main">
        ...
        {loading ? (
          <div className="loading" style={{ padding: 60, textAlign: 'center', color: 'var(--text-muted)' }}>Loading workspaces…</div>
        ) : (
          <>
